...
my_chip = Chip("interconnect")
wire = Wire(my_chip)
Component("test_suite/producer.c", ["speed"])(my_chip, inputs={}, outputs={"z":wire})
Component("test_suite/consumer.c", ["speed"])(my_chip, inputs={"a":wire}, outputs={})
my_chip.generate_verilog()
my_chip.generate_testbench(100000)
my_chip.compile_iverilog(True)
...
my_chip = Chip("interconnect")
wire = Wire(my_chip)
Component("test_suite/slow_producer.c", ["speed"])(my_chip, inputs={}, outputs={"z":wire})
Component("test_suite/consumer.c", ["speed"])(my_chip, inputs={"a":wire}, outputs={})
my_chip.generate_verilog()
my_chip.generate_testbench(100000)
my_chip.compile_iverilog(True)
...
wire = Wire(my_chip)
Component("test_suite/producer.c", ["speed"])(my_chip, inputs={}, outputs={"z":wire})
Component("test_suite/slow_consumer.c", ["speed"])(my_chip, inputs={"a":wire}, outputs={})
my_chip.generate_verilog()
my_chip.generate_testbench(100000)
my_chip.compile_iverilog(True)
